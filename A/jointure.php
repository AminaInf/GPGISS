...
<table border="3px" align="center" width="700px" rules="all">
	...
	<tr align="left" border="2px">
		...
		<th>Aptitude</th><th>Numero</th><th>Echelon</th><th>Echelle</th><th>DateNomination</th><th>Regime</th><th>NomCentre</th>
	</tr>
	
<?php
	$liste=mysql_query("select agent.matricule,idGrade,numeroCNI,numeroMutuel,idG,numeroPermis,id,nom,prenom,dateNaiss,lieuNaiss,ccpa,datteIncorporation,limiteAge,prevention,
				specialite,numeroCim,aptitude,numero,echelon,echelle,dateNomination,regime,centre.nomCentre from agent LEFT JOIN centre ON centre.nomCentre");
