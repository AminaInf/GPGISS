...
<body>
<br/><br/>
<h1 class="pt" align="center">Liste des agents de la 23 CIS</h1>
<?php
session_start();
/*
...
?>
<br/>
<table border="10" align="center" width="800px" rules="all" cellpadding="8">
...
?>
	...
	<tr>
		...
		<td>
			<a href="modifierA23cis.php?id=<?php echo $info['idAgent']; ?>" style="text-decoration:none">Modifier</a>&nbsp;&nbsp;
		</td>
	</tr>
