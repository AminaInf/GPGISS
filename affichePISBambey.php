...
<body>
<br/>
<h1 class="pt" align="center">Liste des agents du PIS de Bambey</h1>
...
?>
	<tr>
		...
		<td>
			<a href="modifierPISBambey.php?id=<?php echo $info['idAgent']; ?>" style="text-decoration:none">Modifier</a>&nbsp;&nbsp;
		</td>
