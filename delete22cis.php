...
<h1 class="pt" align="center">Liste de suppression d'un agent de la 22 CIS </h1>
<?php
...
<?php	
	...
	$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomUnite,numeroCNI,specialite from agentcomp where nomUnite= '22 CIS'");
