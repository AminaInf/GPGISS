<?php
	...
	$query=mysql_query("select* from agent where nomCentre= 'CSIS Khombole'");
...
<h1 class="pt" align="center">Liste de suppression d'un agent du centre de Khombole</h1>
<form method="POST">		
...
<?php	
$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from agent where nomCentre= 'CSIS Khombole'");
	$rowcount=mysql_num_rows($query);
