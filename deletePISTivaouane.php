<?php
	...
	$query=mysql_query("select* from agent where nomCentre= 'CSIS Tivaouane'");
...
<h1 class="pt" align="center">Liste de suppression d'un agent du centre de Tivaouane</h1>
<form method="POST">		
...
<?php	
$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from agent where nomCentre= 'CSIS Tivaouane'");
	$rowcount=mysql_num_rows($query);
