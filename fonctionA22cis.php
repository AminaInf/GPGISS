...
<body>
<br/><br/>
<h1 class="pt" align="center">Resultat de recherche d'un agent de la 22 CIS </h1>
<?php
...
<br/><br/><br/>
	...
	<?php
		$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomUnite,numeroCNI,specialite from  agentcomp WHERE $where and nomUnite='22 CIS'");
