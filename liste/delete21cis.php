...
<h1 class="pt" align="center">Liste pour supprimer un agent du 21 CIS </h1>
<?php
...
<tr bgcolor="#850303">
		...
		<td bgcolor=""><input type="submit" name="del" value="delete"></td> 
	
</tr>
<?php
$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomUnite,numeroCNI,specialite from agentcomp where nomUnite= '21 CIS'");
