<?php
	...
	$query=mysql_query("select* from agent where nomCentre= 'CSIS Saly'");
...
<h1 class="pt" align="center">Liste de suppression d'un agent du centre de Saly</h1>
<form method="POST">		
<table border="1">	
...
<?php	
$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from agent where nomCentre= 'CSIS Saly'");
	$rowcount=mysql_num_rows($query);
