...
<table border="8px" align="center" width="500px" rules="all">
	...
	<?php
		$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomUnite,numeroCNI,specialite from  agentcomp WHERE $where and nomUnite='21 CIS'");
