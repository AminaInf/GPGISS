...
<body>
<br/><br/>
<h1 class="pt" align="center">Resultat de recherche d'un agent du centre de Khombole</h1>
<?php
...
<br/><br/><br/>
	...
	<?php
		$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from  agent WHERE $where and nomCentre='CSIS Khombole'");
