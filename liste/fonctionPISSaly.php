...
<body>
<br/><br/>
<h1 class="pt" align="center">Resultat de recherche d'un agent du centre de Saly</h1>
<?php
...
<table border="" align="center" width="500px" rules="all">
	...
	<?php
		$query=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from  agent WHERE $where and nomCentre='CSIS Saly'");
