...
<body>
<br/><br/>
<h1 class="pt" align="center">Liste des agents du centre de Saly</h1>
<?php
...
<table>
	<tr>
		<a href="recherchePISSaly.php" id="a1">Rechercher</a>&nbsp;&nbsp;
		<a href="affichePISSaly.php" id="a2">Modifier</a>&nbsp;&nbsp;
		<a href="deletePISSaly.php" id="a3">Supprimer</a>&nbsp;&nbsp;
