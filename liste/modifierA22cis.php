...
?>
<br/><br/>
<h1 class="pt" align="center">Modifier un agent de la 22 CIS </h1>
<form action="modifierA22cis.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeAgent22cis.php?mod=Modification bien effectuee");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:modifierA22cis.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
