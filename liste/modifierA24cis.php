...
<head>
<br/><br/>
<h1 class="pt" align="center">Modifier un agent de la 24 CIS </h1>
<?php
session_start();
/* 
...
while($liste=mysql_fetch_array($result))
	{
?>
<form action="modifierA24cis.php" method="POST">
	...
	if(isset($_POST['modifier']))
		{
			...
			$result=mysql_query("update agentcomp set nom='".$nom."',prenom='".$prenom."',dateNaiss='".$dateNaiss."',lieuNaiss='".$lieuNaiss."'
								,idAgent='".$idAgent."',nomUnite='".$nomUnite."',numeroCNI='".$numeroCNI."',specialite='".$specialite."' where idAgent='".$id."'");
				if($result)
					{
						//echo "Modification bien effectue";
						header("location:listeAgent24cis.php?mod=Modification bien effectuee");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:modifierA24cis.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
