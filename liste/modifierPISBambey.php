...
<html>
<br/><br/>
<h1 class="pt" align="center">Modifier un agent du centre de Bambey  </h1>
<?php
session_start();
/* 
...
while($liste=mysql_fetch_array($result))
	{
?>
<form action="modifierPISBambey.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listePISBambey.php?mod=Modification bien effectuee");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:modifierPISBambey.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
