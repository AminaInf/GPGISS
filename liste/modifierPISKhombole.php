...
<body>
<br/><br/>
<h1 class="pt" align="center">Modifier un agent du centre de Khombole  </h1>
<?php
session_start();
/* 
...
while($liste=mysql_fetch_array($result))
	{
?>
<form action="modifierPISKhombole.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listePISKhombole.php?mod=Modification bien effectuee");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:modifierPISKhombole.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
