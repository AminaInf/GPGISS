...
<body>
<br/><br/>
<h1 class="pt" align="center">Modifier un agent du centre de Mekhe </h1>
<?php
session_start();
/* 
...
while($liste=mysql_fetch_array($result))
	{
?>
<form action="modifierPISMekhe.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listePISMekhe.php?mod=Modification bien effectuee");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:modifierPISMekhe.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
