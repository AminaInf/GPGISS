...
<body>
<br/><br/>
<h1 class="pt" align="center">Modifier un agent du centre de Saly</h1>
<?php
session_start();
/* 
...
while($liste=mysql_fetch_array($result))
	{
?>
<form action="modifierPISSaly.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listePISSaly.php?mod=Modification bien effectuee");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:modifierPISSaly.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
