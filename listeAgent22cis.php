...
<body>
<br/><br/>
<h1 class="pt" align="center">Liste des agents du 22 CIS </h1>
...
?>
<?php
	$liste=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomUnite,numeroCNI,specialite from gpgiss.agentcomp where nomUnite='22 CIS'");
...
<table>
	<tr>
		<a href="rechercheA22cis.php" id="a1">Rechercher</a>&nbsp;&nbsp;
		<a href="afficheA22cis.php" id="a2">Modifier</a>&nbsp;&nbsp;
		<a href="delete22cis.php" id="a3">Supprimer</a>&nbsp;&nbsp;
