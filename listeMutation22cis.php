...
<h1 class="pt" align="center">Liste des agents du 22 CIS qui doivent être muter</h1>
</br>
...
<?php
 $i=0;
	$liste=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomUnite,numeroCNI,specialite,refMutt from gpgiss.agentcomp where nomUnite='22 CIS' ");
