...
<h1 class="pt" align="center">Liste des agents du centre de Saly qui doivent être muter</h1>
</br>
<form method="POST" action="modifMutationCentre.php">
<table border="8px" align="center">
	<tr align="left" border="2px" bgcolor="#850303">
		<th>Agent</th><th>Nom</th><th>Prenom</th><th>Date Naiss</th><th>Lieu Naiss</th><th>Matricule</th><th>Nom Centre</th><th>Numero CNI</th><th>Specialite</th><th>Action</th>
	</tr>
<?php
 $i=0;
