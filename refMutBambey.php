...
<table border="3px" align="center" width="800px" rules="all">
	<tr align="left" border="2px" bgcolor="#850303">
		<th>Agent</th><th>Nom</th><th>Prenom</th><th>Date Naiss</th><th>Lieu Naiss</th><th>Matricule</th><th>Nom Centre</th><th>NumeroCNI</th><th>Specialite</th><th>Action</th>
	</tr>
	
<?php
	$liste=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from gpgiss.agent where nomCentre='CSIS Bambey'");
...
?>
	<tr>
		...
		<td>
			<a href="refMutationBambey.php?id=<?php echo $info['idAgent']; ?>" style="text-decoration:none">Choisir RefMut</a>&nbsp;&nbsp;
		</td>
