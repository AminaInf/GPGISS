...
<?php
	$liste=mysql_query("select idAgent,nom,prenom,dateNaiss,lieuNaiss,matricule,nomCentre,numeroCNI,specialite from gpgiss.agent where nomCentre='CSIS Saly'");
...
?>
	<tr>
		...
		<td>
			<a href="refMutationSaly.php?id=<?php echo $info['idAgent']; ?>" style="text-decoration:none">Choisir RefMut</a>&nbsp;&nbsp;
		</td>
