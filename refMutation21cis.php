	...
	if(isset($_POST['enreg']))
		{
			...
			$id=$_POST['idAgent'];
			$result=mysql_query("update agentcomp set refMutt='".$refMutt."' where idAgent='".$id."'");
			 
				if($result)
					{
						//echo "Modification bien effectue";
						header("location:listeMutation21cis.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutation21cis.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
