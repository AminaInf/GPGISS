...
<form action="refMutation22cis.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutation22cis.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutation22cis.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
