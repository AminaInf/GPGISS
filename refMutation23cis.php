...
<form action="refMutation23cis.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutation23cis.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutation23cis.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
