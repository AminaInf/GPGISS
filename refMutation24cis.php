...
<form action="refMutation24cis.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutation24cis.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutation24cis.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
