...
<form action="refMutationKhombole.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutationKhombole.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutationKhombole.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
