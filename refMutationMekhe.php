...
<form action="refMutationMekhe.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutationMekhe.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutationMekhe.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
