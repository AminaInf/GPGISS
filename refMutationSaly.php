...
<form action="refMutationSaly.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutationSaly.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutationSaly.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
