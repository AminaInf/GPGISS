...
<form action="refMutationTivaouane.php" method="POST">
				...
				if($result)
					{
						...
						header("location:listeMutationTivaouane.php?mod=Insertion reussie");
						exit();
					}
				else
					{
						//echo "Echec de modification";
						header("location:refMutationTivaouane.php?mod=Echec modification&id=$id");
						exit();
					}
		}
?>
